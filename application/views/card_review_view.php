...
<section role="main" id="main">
    ...
    <div class="with-padding">
        ...
        <form class="columns" method="post" id="reviewcard" action="#">


            <div class="twelve-columns twelve-columns-tablet twelve-columns-mobile">

                <h3 class="thin underline">Vérifier les informations ci-dessous:</h3>
            </div>
            ...
            <div class="four-columns twelve-columns-tablet twelve-columns-mobile">
                ...
                <div class="block margin-bottom">
                    ...
                    <div class="with-padding">
                        ...
                        <p class="inline-large-label button-height">
                            <label for="nom_rue" class="label">Nom de la Rue: <small>(200 chars max.)</small></label>
                        ...
                        <p class="inline-large-label button-height">
                            ...
                            <input type="text" name="numero" id="numero" class="input small-margin-right validate[required]" value="<?php echo $personnes_physiques['numero_rue']; ?>">
            ...
            <div class="six-columns twelve-columns-tablet twelve-columns-mobile">
                ...
                <div class="block margin-bottom" style="min-height: 295px;">
                    ...
                    <div class="with-padding">
                        ...
                        <p class="wrapped relative" style="min-height: 65px">
...
<script>
    ...
    //$('.navigable a').removeClass('current navigable-current');

    $(document).ready(function(){
        $('#myprofile').addClass('current navigable-current');
